...
const AllBlogs = () => {
  ...
  if (error)
    return (
      <div className="h-screen text-center flex items-center justify-center dark:bg-black">
        <h1 className="text-4xl dark:text-white ">{error}</h1>
      </div>
    );
  return (
    <div className="bg-slate-100 dark:bg-gray-950 dark:text-white">
      <h1 className="text-3xl text-center font-medium py-4 dark:text-white lg:text-5xl lg:py-10">
        All Blogs
      </h1>
      <SearchBlogForm />
